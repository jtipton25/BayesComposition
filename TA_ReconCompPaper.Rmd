...
source(here("data", "join-testate.R"))
## remove zeros
...
if (file.exists(here(progress_directory, save_file))) {
  load(here(progress_directory, save_file))  
} else {
...
source(here("data", "join-testate-caribou.R"))
