...
raw_data <- read.csv(file="~/Documents/connoR/testate/data/North American Raw Testate - Paleon 2017-Sheet1.csv", 
                     skip=6)
y <- raw_data[, 12:85]
X <- raw_data$WTD..cm.
...
dev.copy(pdf, "cv-plot1.pdf", width=10,height=10)
